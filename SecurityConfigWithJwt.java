...
public class SecurityConfigWithJwt {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // Autoriser l'accès à l'endpoint de recommandations avec authentification JWT
                .requestMatchers("/api/recommendations/**").authenticated()
                // Autoriser l'accès aux endpoints publics (actuator, health, etc.)
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Durée de mise en cache des preflight requests (1 heure)
